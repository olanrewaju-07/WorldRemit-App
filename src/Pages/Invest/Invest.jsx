      ...
      <div className="flex flex-col justify-start">
        ...
        <div className="flex flex-row gap-16 items-center ml-28 mt-5">
          ...
          <div className="flex flex-col">
            ...
            <span>Own top US stock like Nike, Amazon, Tesla & more</span>
          </div>
        </div>
        <div className="flex flex-row gap-16 items-center ml-28 mt-5">
          ...
          <div className="flex flex-col">
            ...
            <span>Fatest trade execution & confirmation</span>
          </div>
        </div>
        <div className="flex flex-row gap-16 items-center ml-28 mt-5 ">
          ...
          <div className="flex flex-col">
            ...
            <span>SIPC protection of securities and cash up to $500,000 USD</span>
          </div>
        </div>
      </div>
      <button className='bg-[rgb(129,0,129)] text-white text-xl font-semibold p-2 rounded-lg w-[50%] mt-24 ml-80'>Begin Investing</button>
    </div>
  );
}
